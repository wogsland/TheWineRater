...
define("_ASREGISTERED","Не зарегистрировались? Вы можете зделать это нажав <a href=\"modules.php?name=Your_Account\">Здесь</a>. Когда вы зарегистрируетесь, вы получите полный доступ к управлению сайтом, сможите изменять его внешний вид по вашему желанию и т.д.");
...
define("_YOUAREANON","Вы Анонимный пользователь. Вы можете зарегистрироваться нажав <a href=\"modules.php?name=Your_Account\">здесь</a>");
define("_NOTE","Запись:");
