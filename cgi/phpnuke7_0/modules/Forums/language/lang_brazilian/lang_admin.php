...
$lang['Users'] = 'Admin Usuários';
$lang['Groups'] = 'Admin Grupos';
$lang['Forums'] = 'Admin Fóruns';
...
$lang['Ban_Management'] = 'Controle Expulsões';
...
$lang['Not_admin'] = 'Você não tem autorização para administrar o Fórum de Discussão';
$lang['Welcome_phpBB'] = 'Bem-vindo ao Fórum de Discussão';
$lang['Admin_intro'] = 'Esta área possibilita a visualização global das estatísticas dos seus fóruns. Você poderá voltar aqui clicando em <u>Índice do Admin</u> no painel esquerdo. Para voltar ao Índice global dos fóruns clique no logo phpBB. Os outros atalhos lhe dão acesso aos diversos painéis de controle dos fóruns, cada um possui instruções de como usá-lo.';
$lang['Main_index'] = 'Índice do Fórum';
$lang['Forum_stats'] = 'Estatísticas do Fórum';
$lang['Admin_Index'] = 'Índice do Admin';
$lang['Preview_forum'] = 'Prever Fórum';

$lang['Click_return_admin_index'] = 'Clique %sAqui%s para retornar ao Índice do Admin';
...
// DB Utils
//
$lang['Database_Utilities'] = 'Utilitários do Banco de Dados (BD)';

$lang['Restore'] = 'Restaurar';
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'Isso executará uma restauração completa de todas as tabelas do phpBB a partir de um arquivo salvo. Caso o seu servidor permita você poderá enviar um arquivo de texto compactado em Gzip e ele será descompactado automaticamente. <b>ATENÇÃO:</b> Esta operação sobrescreverá qualquer informação existente. Dependendo do tamanho de seu Banco de Dados este processo poderá levar algum tempo. Não saia desta página até que o processo seja finalizado.';
$lang['Backup_explain'] = 'Aqui você pode fazer um backup de todos os dados relacionados ao seu phpBB. Se desejar copiar tabelas adicionais que estejam no Banco de Dados escreva na caixa de texto "Tabelas Adicionais" os nomes das tabelas separados por vírgulas. Caso o seu servidor permita, você poderá compactar o arquivo em gzip de forma a reduzir o seu tamanho antes de copiá-lo.';
...
$lang['Restore_success'] = 'O Banco de Dados foi restaurado com sucesso.<br/><br/>Os seus fóruns deverão voltar agora ao estado em que se encontravam no momento em que foram copiados.';
$lang['Backup_download'] = 'A cópia deverá iniciar em breve. Por favor, aguarde até que comece.';
$lang['Backups_not_supported'] = 'O seu sistema de Banco de Dados não permite que o backup seja realizado';
...
$lang['Restore_Error_decompress'] = 'Não é possível descompactar um arquivo Gzip. Por favor, envie uma versão texto.';
...
$lang['Group_auth_explain'] = 'Aqui você pode alterar as permissões e o status de moderador de cada Grupo de Usuários. Não se esqueça de que ao alterar as permissões de um Grupo, as permissões de um Usuário ainda podem permitir que ele entre nos fóruns, etc. Você será avisado caso isto aconteça.';
$lang['User_auth_explain'] = 'Aqui você pode alterar as permissões e o status de moderador atribuído individualmente a cada Usuário. Não se esqueça de que ao mudar as permissões de um Usuário, as permissões de Grupo ainda podem permitir que ele entre nos fóruns, etc. Você será avisado caso isto aconteça.';
$lang['Forum_auth_explain'] = 'Aqui você pode alterar os níveis de autorização de cada fórum. Você terá o método Simples e o Avançado para fazer isso, sendo que o Avançado oferece maior controle das operações de cada fórum. Lembre-se de que a alteração do nível de permissão de seu fórum afetará o que cada usuário pode fazer e onde ele pode fazer.';
...
$lang['Conflict_access_groupauth'] = 'O seguinte Usuário (ou Usuários) ainda possuem direitos de acesso a este fórum através de sua Configuração de Permissões de Usuário. Talvez você queira alterar as permissões de Usuário para bloquear por completo os seus direitos de acesso. As permissões dos Usuários (e os fóruns envolvidos) estão indicados abaixo:';
...
$lang['Click_return_userauth'] = 'Clique %sAqui%s para voltar às Permissões de Usuário';
$lang['Click_return_groupauth'] = 'Clique %sAqui%s para voltar às Permissões de Grupo';
$lang['Click_return_forumauth'] = 'Clique %sAqui%s para voltar às Permissões de Fórum';
...
$lang['Ban_explain'] = 'Aqui você pode controlar a expulsão de Usuários. Você pode expulsar um Usuário específico ou um grupo de endereços de IP ou \'hostnames\'. Estes métodos impedem os Usuários de terem acesso inclusive à página inicial dos fóruns. Para evitar que um Usuário se registe com um nome de Usuário diferente você pode também banir um endereço de email específico. Note que ao banir apenas o email não impede um Usuário de se logar ou colocar mensagens nos fóruns. Você deve usar um dos dois métodos descritos inicialmente.';
$lang['Ban_explain_warn'] = 'Note que ao especificar um grupo de endereços de IP resultará no banimento de TODOS os endereços incluidos nessa seleção, ou seja, serão adicionados à lista de IPs banidos desde o primeiro IP até ao último. O sistema do phpBB tenta minimizar o número de endereços a adicionar ao Banco de Dados empregando automaticamente filtros de seleção sempre que for possível. Se você realmente tiver que mencionar um grupo de IPs tente fazê-lo de forma a abranger uma quantidade reduzida de endereços ou, melhor ainda, use endereços específicos.';
...
$lang['Ban_username'] = 'Expulsar um ou mais Usuários específicos';

$lang['Ban_IP'] = 'Expulsar um ou mais endereços de IP ou hostnames';
$lang['IP_hostname'] = 'Endereços de IP ou hostnames';
$lang['Ban_IP_explain'] = 'Quando usar mais do que um IP e \'hostname\' separe cada item com uma vírgula. Para especificar um grupo de endereços de IP separe o início do fim com um traço (-). Pode também usar asteriscos (*)';

$lang['Ban_email'] = 'Expulsar um ou mais endereços de email';
$lang['Ban_email_explain'] = 'Quando usar mais do que um email separe cada item com uma vírgula. Para especificar um usuário qualquer de um certo provedor, utilize asteriscos '*', como por exemplo, *@hotmail.com';
...
$lang['Unban_IP_explain'] = 'Você remover a expulsão de vários endereços de IP simultaneamente usando a combinação apropriada de teclas e cliques do mouse no seu computador ou browser.';

$lang['Unban_email'] = 'Remover a expulsão de um ou mais endereços de email';
$lang['Unban_email_explain'] = 'Você remover a expulsão de vários endereços de email simultaneamente usando a combinação apropriada de teclas e cliques do mouse no seu computador ou browser.';

$lang['No_banned_users'] = 'Não há Nomes de Usuários expulsos';
$lang['No_banned_ip'] = 'Não há endereços de IP expulsos';
$lang['No_banned_email'] = 'Não há endereços de email expulsos';
...
$lang['Config_explain'] = 'O Formulário abaixo permite a personalização de todas as opções gerais do seu phpBB. Para configurações de Fóruns ou Usuários use os respectivos links no painel esquerdo.';
...
$lang['Server_name_explain'] = 'O nome do Domínio em que está instalado fórum';
$lang['Script_path'] = 'Diretório do Script';
$lang['Script_path_explain'] = 'O diretório onde se encontra o phpBB em relação ao Domínio';
...
$lang['Board_disable_explain'] = 'Isto torna os fóruns inacessíveis aos Usuários. Não execute logout após Desativar os fóruns senão você não conseguirá entrar novamente.';
...
$lang['Max_poll_options'] = 'Número máximo de opções por Enquete';
...
$lang['Board_email_form_explain'] = 'Função que permite Usuários enviarem email a outros através do phpBB';
$lang['Topics_per_page'] = 'Número Máximo de Tópicos por página';
$lang['Posts_per_page'] = 'Número Máximo de Mensagens por página';
$lang['Hot_threshold'] = 'Número Máximo de Mensagens para tornar um Tópico Popular';
...
$lang['Max_avatar_size'] = 'Dimensões Máximas dos Avatares';
...
$lang['COPPA_mail_explain'] = 'Este é o endereço de email para o qual os pais enviarão os formulários de registro de COPPA';
...
$lang['SMTP_password_explain'] = 'Só escreva a Senha caso o seu servidor de SMTP assim o exigir';
...
$lang['Savebox_limits'] = 'Número Total de mensagens permitidas na Caixa de Mensagens Salvas';
...
$lang['Cookie_settings_explain'] = 'Esses detalhes definem como os cookies serão enviados para os navegadores dos seus Usuários. Na maioria dos casos os valores padrão para a configuração dos cookies deverão ser suficientes, caso necessite mudá-los faça com cuidado pois uma configuração incorreta poderá impedir os Usuários de logarem-se.';
...
$lang['Cookie_secure_explain'] = 'Se o seu servidor estiver rodando através de SSL ative-o, caso contrário deixe-o desligado';
...
$lang['Forum_admin_explain'] = 'A partir deste Painel você pode adicionar, remover, editar, reordenar e resincronizar Categorias e Fóruns.';
...
$lang['Config_updated'] = 'A configuração do Fórum foi atualizada com sucesso!';
$lang['Edit'] = 'Editar';
$lang['Delete'] = 'Remover';
...
$lang['Forum_edit_delete_explain'] = 'O formulário abaixo lhe permitirá personalizar todas as Opções Gerais do phpBB. Para Configurações de Usuários e do Fórum use os atalhos no painel do lado esquerdo.';
...
$lang['Set_prune_data'] = 'Você ativou a função de auto-limpeza para este fórum mas não especificou a freqüência ou o número de dias em que o mesmo deve ser limpo. Volte e especifice esse valor';
...
$lang['Forums_updated'] = 'Informações do Fórum e da Categoria atualizadas com sucesso!';
...
$lang['smile_desc'] = 'A partir desta página você pode adicionar, remover e editar os \'smileys\' que os Usuários poderão usar nas suas mensagens.';
...
$lang['Look_up_user'] = 'Perfil do Usuário';

$lang['Admin_user_fail'] = 'Não foi possível Atualizar o perfil do Usuário.';
...
$lang['User_special_explain'] = 'Estes campos não podem ser modificados por Usuários. Aqui você pode especificar o status do usuário bem como outras opções que não são dadas aos Usuários.';
...
$lang['Group_admin_explain'] = 'A partir deste painel você pode administrar todos os seus Grupos de Usuários, você pode: remover, criar e editar Grupos existentes. Você pode eleger moderadores, abrir/fechar Grupos e definir Nome e Descrição de cada grupo.';
...
$lang['Prune_success'] = 'A otimização dos fóruns foi concluída com sucesso';
...
$lang['Words_explain'] = 'A partir deste painel de controle você pode adicionar, editar e remover palavras que serão automaticamente censuradas em seus fóruns. O uso dessas palavras será também interditado no registo de Nomes de Usuários. Podem ser usados asteriscos (*) aumentando as possibilidades de abranger variações da mesma palavra. Por exemplo, *testa* abrangerá detestando, testa* abrangerá testando, *testa abrangerá detesta.';
$lang['Word'] = 'Palavra';
...
$lang['Click_return_wordadmin'] = 'Clique %sAqui%s para voltar às Palavras Censuradas';


//
// Mass Email
//
$lang['Mass_email_explain'] = 'A partir daqui você pode enviar um email para todos os Usuários dos fóruns ou apenas para Usuários membros de um certo grupo. Será enviada uma mesnagem para o <b>Email Administrativo</b> previamente configurado com uma cópia oculta para os demais usuários. Caso esteja enviando um email para um grande número de pessoas aguarde um pouco após clicar em <b>Email</b> e não pare a página durante o processo. É normal que o envio de um email em massa demore um pouco, mas você será avisado quando o processo for concluído.';
$lang['Compose'] = 'Compor';
...
$lang['Ranks_explain'] = 'Usando este formulário você pode adicionar, editar, ver e remover ranks. Você também pode criar ranks específicos que podem ser atribuídos aos Usuários através do painel <b>Admin Usuários</b>';
...
$lang['Click_return_rankadmin'] = 'Clique %sAqui%s para voltar à Gerência de Ranks';
...
$lang['Disallow_explain'] = 'Aqui você pode controlar nomes de Usuários que não serão permitidos. Nomes proibídos podem conter asteriscos '*' para abranger um maior número de variações da palavra.  Note que não podem ser especificados Nomes de Usuários que já se encontrem registrados, devendo primeiro ser removidos e então especificados aqui para não mais serem usados.';
...
$lang['Click_return_disallowadmin'] = 'Clique %sAqui%s para voltar ao Controle de Nomes de Usuários Proibidos';
...
$lang['Styles_explain'] = 'Use este painel para adicionar, remover e administrar os estilos (Modelos e Temas) que ficarão disponíveis aos Usuários.';
$lang['Styles_addnew_explain'] = 'A lista a seguir contém todos os Temas disponíveis para os Modelos que você possui. Os itens desta lista ainda não se encontram instalados na base de dados do phpBB. Para instalar um tema específico clique em <b>Instalar</b> ao lado desse item.';
...
$lang['Export_explain'] = 'Neste painel você poderá exportar os dados de um Tema para um dado Modelo. Escolha um Modelo na lista e será automaticamente criado um arquivo de configuração do tema que irá ser guardado e instalado na pasta do Modelo selecionado. Caso não seja possível salvá-lo será dada a opção para fazer o \'download\'. Para que o arquivo seja salvo deve ser dada permissão de escrita ao servidor WEB para a pasta do Modelo selecionado. Para mais informação sobre esta operação veja o <b>guia de usuários phpBB 2</b>.';
...
$lang['Theme_info_saved'] = 'A informação do tema para o Modelo selecionado foi salva. Você deve agora mudar as permissões para \'read-only\' do arquivo theme_info.cfg (e caso aplicável na pasta de Modelos)';
...
$lang['Download_theme_cfg'] = 'Não foi possível escrever o arquivo de informação do tema. Clique sobre o botão abaixo para fazer o \'download\' deste arquivo. Ao terminar o download você pode trasferir o arquivo para a pasta que contém os arquivos de Modelos. Você pode empacotar os arquivos para distribuição ou usar em outro local, se desejar';
$lang['No_themes'] = 'O Modelo selecionado não possui temas anexos. Para criar um tema novo clique em Criar no painel do lado esquerdo';
$lang['No_template_dir'] = 'Não foi possível abrir a pasta de Modelos. Pode ser que não haja possibilidade de ser lido pelo servidor Web ou a pasta não exista';
$lang['Cannot_remove_style'] = 'Você não pode remover o estilo selecionado porque está em uso no momento. Mude para outro estilo e tente novamente.';
$lang['Style_exists'] = 'O nome para o estilo que selecionou já existe, volte e escolha um nome diferente.';
...
$lang['Hidde_last_logon_expain'] = 'Se escolher SIM, a data da última visita do usuário permanecerá oculta para os usuários exceto para os ADMINISTRADORES';

// Real Name MOD
$lang['Hidde_real_name'] = 'Ocultar Nome Real';
$lang['Hidde_real_name_explainn'] = 'Se escolher SIM, o nome real dos usuários permanecerá oculto para os usuários exceto para os ADMINISTRADORES.';

// Yellow Card Admin MOD
$lang['Ban'] = 'Banir';
$lang['Max_user_bancard'] = 'Núm. Máx. de cartões amarelos';
$lang['Max_user_bancard_explain'] = 'Se um usuário exceder o limite de cartões amarelos será expulso';
$lang['ban_card'] = 'Cartões Amarelos';
$lang['ban_card_explain'] = 'O usuário será expulso quando ele/ela exceder %d cartões amarelos';
...
$lang['continue_upgrade'] = 'Assim que terminar o \'download\' do arquivo de configuração para o seu computador você poderá clicar em \"Continuar a Atualização\" para continuar o processo.  Aguarde que seja feito o \'upload\' do arquivo de configuração até que o processo de atualização esteja completo.';
...
$lang['Re_install'] = 'A sua instalação anterior ainda se encontra ativa. <br/><br/>Caso pretenda reinstalar phpBB 2 clique no botão Sim abaixo. Note que ao fazê-lo toda a informação existente será destruída, não sendo feitas cópias de segurança! O Nome de Usuário e Senha de administrador que você tem usado serão recriados após esta reinstalação, nenhum outro dado de configuração será salvo.<br/><br/>Pense cuidadosamente antes clicar em Sim!';

$lang['Inst_Step_0'] = 'Obrigado por ter escolhido phpBB 2. A fim de completar esta instalação preencha os detalhes pedidos abaixo. Note que a base de dados onde a informação do fórum será instalada já deve existir. Caso a base de dados use ODBC (ex: MS Access), crie primeiro um DSN.';
...
$lang['Inst_Step_2'] = 'O seu Nome de Usuário para Administrador foi criado. A Instalação Básica foi concluída. Você será conduzido a um painel onde poderá administrar a sua nova instalação. Verificar os detalhes de Configuração Geral e proceder as mudanças necessárias. Obrigado por usar phpBB 2.';

$lang['Unwriteable_config'] = 'O seu arquivo de configuração não pode ser escrito neste momento. Será feita uma cópia do arquivo ao clicar no botão abaixo. Deverá colocar este arquivo na mesma pasta que o phpBB 2. Uma vez concluido, você deverá logar-se usando o Nome de Usuário de administrador e respectiva senha que forneceu anteriormente visitando a seguir o Painel de Administração (um atalho irá surgir na parte inferior de cada janela) para verificar a configuração geral. Obrigado por escolher phpBB 2.';
$lang['Download_config'] = 'Faça o \'Download\' da Configuração';

$lang['ftp_choose'] = 'Escolher um método para Download';
$lang['ftp_option'] = '<br/>Visto as extensões de FTP se encontrarem ativas nesta versão de PHP deve-lhe ter sido também dada a opção para primeiro tentar automaticamente o FTP do arquivo de configuração para o local certo.';
$lang['ftp_instructs'] = 'Escolheu para FTP automaticamente o arquivo para a conta contendo phpBB 2.  Por favor forneça a informação abaixo para facilitar o processo. Note que o \'path\' do FTP deverá ser exatamente o mesmo via ftp para a instalação do seu phpBB 2 como se estivesse efetuando ftp usando um cliente normal.';
...
$lang['NoFTP_config'] = 'A tentativa de FTP do arquivo de configuração para o local correto falhou. Por favor, faça o download do mesmo e efetue o FTP manualmente.';
