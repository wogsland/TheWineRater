<?php
/***************************************************************************
 *                            lang_admin_attach.php [Chinese]
 *                              -------------------
 *     begin                : Thu Feb 07 2002
 *     copyright            : (C) 2002 Meik Sievertsen
 *     email                : acyd.burn@gmx.de
 *     Translation          : Sp Lin , splin@cpalm.idv.tw (For Attachment Mod 2.32)
 *     $Id: lang_admin_attach.php,v 1.15 2002/09/16 18:38:29 meik Exp $
 *
 *
 ****************************************************************************/
...
$lang['Sort_Descending'] = '遞減'; 
$lang['Sort_Ascending'] = '遞增'; 
$lang['Show_apcp'] = '顯示新版附加檔案發表控制台';
$lang['Show_apcp_explain'] = '選擇 2.32 版以後的新版附加檔案發表控制台(選擇:是)或者是選 2.24 以前舊版的附加檔案發表控制台(選擇:否)。這個有點難以解釋，因此您還是自己去試一試囉!';
// 2.3.4
...
$lang['Group_permissions_title'] = '副檔名群組權限 -> \'%s\'';
